...
class LoadStatus extends $pb.GeneratedMessage {
  ...
  factory LoadStatus.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);

  factory LoadStatus.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'LoadStatus',
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'status')
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  LoadStatus copyWith(void Function(LoadStatus) updates) =>
      super.copyWith((message) => updates(message as LoadStatus)) as LoadStatus;
  ...
  @$core.pragma('dart2js:noInline')
  static LoadStatus getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<LoadStatus>(create);
...
class GameRequest extends $pb.GeneratedMessage {
  ...
  factory GameRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);

  factory GameRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.int>(
        2, _omitFieldNames ? '' : 'numberOfPlayers', $pb.PbFieldType.O3,
        protoName: 'numberOfPlayers')
    ..a<$core.int>(3, _omitFieldNames ? '' : 'gameSpeed', $pb.PbFieldType.O3,
        protoName: 'gameSpeed')
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  set numberOfPlayers($core.int v) {
    $_setSignedInt32(1, v);
  }
...
class GameStatus extends $pb.GeneratedMessage {
  ...
  factory GameStatus.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);

  factory GameStatus.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..a<$core.int>(
        1, _omitFieldNames ? '' : 'numberOfPlayers', $pb.PbFieldType.O3,
        protoName: 'numberOfPlayers')
...
class TimeRequest extends $pb.GeneratedMessage {
  ...
  factory TimeRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);

  factory TimeRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
...
class ScoreResponse extends $pb.GeneratedMessage {
  ...
  factory ScoreResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);

  factory ScoreResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.int>(3, _omitFieldNames ? '' : 'totalScore1', $pb.PbFieldType.O3,
        protoName: 'totalScore1')
    ..a<$core.int>(4, _omitFieldNames ? '' : 'totalScore2', $pb.PbFieldType.O3,
        protoName: 'totalScore2')
    ..hasRequiredFields = false;
  ...
  static $pb.PbList<ScoreResponse> createRepeated() =>
      $pb.PbList<ScoreResponse>();
...
class EndRequest extends $pb.GeneratedMessage {
  ...
  factory EndRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);

  factory EndRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'EndRequest',
      createEmptyInstance: create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  EndRequest copyWith(void Function(EndRequest) updates) =>
      super.copyWith((message) => updates(message as EndRequest)) as EndRequest;
  ...
  @$core.pragma('dart2js:noInline')
  static EndRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<EndRequest>(create);
...
class EndStatus extends $pb.GeneratedMessage {
  ...
  factory EndStatus.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);

  factory EndStatus.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'EndStatus',
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'status')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  EndStatus copyWith(void Function(EndStatus) updates) =>
      super.copyWith((message) => updates(message as EndStatus)) as EndStatus;
  ...
  @$core.pragma('dart2js:noInline')
  static EndStatus getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<EndStatus>(create);
