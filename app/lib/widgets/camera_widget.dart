    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 80, vertical: 80), // Padding from edges
            child: Column(
              children: [
                Expanded(
                  child: Container(
                    ...
                    child: _localStream != null
                      ...
                      transform: Matrix4.rotationY(3.14159), // 180 degrees to flip horizontally
                      child: RTCVideoView(
                        _renderer,
                        objectFit: RTCVideoViewObjectFit.RTCVideoViewObjectFitCover, // Fits to cover the container
                      ),
                    )
          ...
          // Close button as FloatingActionButton
          Positioned(
            top: 20,
            left: 20,
